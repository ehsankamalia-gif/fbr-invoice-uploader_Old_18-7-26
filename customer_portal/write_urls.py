with open("customer_portal/urls.py", "wb") as f:
    f.write(b'''from django.contrib import admin
...
from portal.views import (
    ...
    custom_admin_spare_ledger_transactions_view,
    custom_admin_spare_ledger_monthly_summary_view,
    custom_admin_spare_ledger_monthly_report_view,
    export_sales_csv,
    export_payments_csv,
    get_customer_data,
...
urlpatterns = [
    ...
    path('spare-ledger/transactions/', custom_admin_spare_ledger_transactions_view, name='custom_admin_spare_ledger_transactions'),
    path('spare-ledger/monthly-summary/', custom_admin_spare_ledger_monthly_summary_view, name='custom_admin_spare_ledger_monthly_summary'),
    path('spare-ledger/monthly-report/', custom_admin_spare_ledger_monthly_report_view, name='custom_admin_spare_ledger_monthly_report'),
...
print("Successfully created clean urls.py file")
