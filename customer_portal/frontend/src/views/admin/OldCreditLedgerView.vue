...
import { getOldCreditLedger } from '../../api/admin';
...
onMounted(async () => {
  const data = await getOldCreditLedger();
...
<template>
  <div>
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-gray-800 mb-2"><i class="fas fa-book mr-3"></i>Old Running Credit Ledger</h1>
      <p class="text-gray-600">All old running credit transactions</p>
    </div>
