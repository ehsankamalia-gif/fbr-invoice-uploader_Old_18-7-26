...
export const getInvoicePricePreviewByModel = (productModelId, color) =>
  api.get(`admin/invoices/price-preview-by-model/${productModelId}/`, { params: { color } }).then((r) => r.data);
export const createInvoice = (data) => api.post('admin/invoices/create/', data).then((r) => r.data);
export const lookupCustomerByCnic = (cnic) =>
  api.get('admin/invoices/customer-lookup/', { params: { cnic } }).then((r) => r.data);
